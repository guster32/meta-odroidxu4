...
PROVIDES:remove:odroid  = "${@bb.utils.contains('MACHINE_FEATURES', 'mali', ' virtual/libgles1 virtual/libgles2 virtual/libgles3 virtual/egl virtual/libegl', '', d)}"
PROVIDES:remove:odroid  = "${@bb.utils.contains('DISTRO_FEATURES', 'wayland', ' virtual/libgbm virtual/libwayland-egl ', '', d)}"
