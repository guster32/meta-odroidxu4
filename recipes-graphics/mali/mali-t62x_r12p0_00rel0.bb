...
RREPLACES:${PN} += " libegl libgles1 libglesv1-cm1 libgles2 libglesv2-2 libOpenCL libGLESv2.so libEGL.so "
RPROVIDES:${PN} += " libegl libgles1 libglesv1-cm1 libgles2 libglesv2-2 libOpenCL libGLESv2.so libEGL.so "
RCONFLICTS:${PN} = " libegl libgles1 libglesv1-cm1 libgles2 libglesv2-2 libOpenCL libGLESv2.so libEGL.so "

RREPLACES:${PN} += "${@bb.utils.contains("DISTRO_FEATURES", "wayland", " libgbm libwayland-egl.so libEGL.so ", " ", d)}"
RPROVIDES:${PN} += "${@bb.utils.contains("DISTRO_FEATURES", "wayland", " libgbm libwayland-egl.so libEGL.so ", " ", d)}"
RCONFLICTS:${PN} += "${@bb.utils.contains("DISTRO_FEATURES", "wayland", " libgbm libwayland-egl.so libEGL.so ", " ", d)}"
